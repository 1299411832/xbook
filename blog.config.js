...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '迷体星球', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '手工造物、元宇宙、人工智能、社交、旅行和虚拟现实，歌手、策划、乐手集一身的星球', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://h.miti.cc.cd', // 网站地址
